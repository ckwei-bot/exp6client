...
class TestAESEncryptClient4 {

    static boolean autogen;
    static short[] msg4 = {0x32, 0x43, 0xf6, 0xa8,
            0x88, 0x5a, 0x30, 0x8d,
            0x31, 0x31, 0x98, 0xa2,
            0xe0, 0x37, 0x07, 0x34};
    ...
    static SecureRandom rnd4 = new SecureRandom();
    ...
    static void generateData() throws Exception {
        ...
        for (int i = 0; i < 16; i++) {
            msg4[i] = (short) rnd4.nextInt(0xff);
...
//	AESEncryptClient aesEncryptClient = new AESEncryptClient(msg, 4);
        AESEncryptClient4 aesEncryptClient4 = new AESEncryptClient4(msg4, 4);
        aesEncryptClient4.run();
    }
}