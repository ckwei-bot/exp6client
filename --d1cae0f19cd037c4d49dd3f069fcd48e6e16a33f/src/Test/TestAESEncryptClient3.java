...
class TestAESEncryptClient3 {

    static boolean autogen;
    static short[] msg3 = {0x32, 0x43, 0xf6, 0xa8,
            0x88, 0x5a, 0x30, 0x8d,
            0x31, 0x31, 0x98, 0xa2,
            0xe0, 0x37, 0x07, 0x34};
    ...
    static SecureRandom rnd3 = new SecureRandom();
    ...
    static void generateData() throws Exception {
        ...
        for (int i = 0; i < 16; i++) {
            msg3[i] = (short) rnd3.nextInt(0xff);
...
//	AESEncryptClient aesEncryptClient = new AESEncryptClient(msg, 4);
        AESEncryptClient3 aesEncryptClient3 = new AESEncryptClient3(msg3, 4);
        aesEncryptClient3.run();
    }
}