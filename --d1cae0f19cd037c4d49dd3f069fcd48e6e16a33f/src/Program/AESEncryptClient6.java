...
//
//
//public class AESEncryptClient6 extends ProgClient6 {
//
...
//    State outputState;
//
//    public AESEncryptClient6(short[] msgIn,int NkIn) {
//        msg = msgIn;
...
//        AESEncryptCommon.Nk = AESEncryptCommon.ois6.readInt();
//        AESEncryptCommon.Nr = AESEncryptCommon.Nk + 6;
//
//        // AESEncryptCommon.initCircuits();
//
//        LookupTableReceiver.ois = AESEncryptCommon.ois6;
...
//            slbs[i] = Utils.readBigInteger(bytelength, AESEncryptCommon.ois6);
//        }
...
//
//
//        rcver6.execProtocol(m);//每个client都需要执行
//        clbs = rcver6.getData();
//        StopWatch.taskTimeStamp("receiving labels for self's inputs");
//        clbs_own = rcver6.getData();
